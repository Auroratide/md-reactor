...
module.exports = class Context {
  constructor() {
    ...
    this.asBlock = new Parser([ BasicCodeBlock, HighlightedCodeBlock, UnorderedList, OrderedList, HorizontalRule, Blockquote, Header, HeaderAlt, Paragraph, Ignore ], this);
  }
};