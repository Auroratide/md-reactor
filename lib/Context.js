...
module.exports = class Context {
  constructor() {
    this.asInline = new Parser([ Image, Link, AutoLink, Strong, Emphasis, Strikethrough, Character ], this);
    this.asBlock = new Parser([ CodeBlock, UnorderedList, OrderedList, Header, HeaderAlt, Paragraph, Ignore ], this);
  }
};